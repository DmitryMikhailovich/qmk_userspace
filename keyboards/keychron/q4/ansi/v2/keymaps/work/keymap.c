...
TD(TD_LSFT_CAPS),           KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,                  KC_RSFT,
    ...
    [HOLD_CAPS] = LAYOUT_ansi_61(
        ...
        _______, _______,  _______, _______, _______, _______, KC_HOME, KC_PGUP, KC_INS,  _______, _______,  _______,  _______,        _______,
        _______, _______,  _______,  KC_DEL, _______, _______, KC_LEFT, KC_DOWN,  KC_UP, KC_RIGHT, _______,  _______,                  _______,
        _______,           _______, _______, C(KC_C), C(KC_V), _______, KC_END, KC_PGDN,   KC_DEL, _______,  _______,                  _______,
        _______, _______,  _______,                            _______,                            _______,  _______,  _______,        _______)
