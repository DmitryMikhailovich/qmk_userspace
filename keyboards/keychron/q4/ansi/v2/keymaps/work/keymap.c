...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    M_CAPS_LOCK, KC_A,     KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,                  KC_ENT,
        ...
        KC_LCTL, KC_LOPT,  KC_LCMD,                            KC_SPC,                             KC_RCMD,  M_MAC_FN1,M_MAC_FN2,      M_RCTL),
    ...
    M_CAPS_LOCK,  KC_A,     KC_S,   KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,                  KC_ENT,
        KC_LSFT,            KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,                  M_RSFT,
        KC_LCTL,  KC_LGUI,  KC_LALT,                           KC_SPC,                             KC_RALT,  M_WIN_FN1,M_WIN_FN2,      M_RCTL),

    [MAC_FN2] = LAYOUT_ansi_61(
        ...
        _______, _______,  _______,                            _______,                            _______,MO(MAC_FN1),_______,        _______),
    ...
    [HOLD_CAPS] = LAYOUT_ansi_61(
        ...
        XXXXXXX, KC_MPLY,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, XXXXXXX,  XXXXXXX,  XXXXXXX,        KC_CAPS,
